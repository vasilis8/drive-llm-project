...
\midrule
$w_s$ (speed)              & 3.0   & \textbf{6.0}   & \textbf{1.0}   & \textbf{2.5}   & 3.0 \\
$w_m$ (smoothness)         & 0.1   & \textbf{0.05}  & \textbf{0.3}   & 0.1            & 0.1 \\
$w_l$ (lane dev.)          & 0.5   & 0.1            & 0.1            & \textbf{0.5}   & 0.5 \\
$w_b$ (speed bonus)        & 2.0   & \textbf{4.0}   & \textbf{0.5}   & \textbf{1.5}   & 2.0 \\
$r_{\text{crash}}$         & $-15$ & $-15$          & $-15$          & $-15$          & $-15$ \\
\bottomrule
\end{tabular}
\end{table}
...
Phase 2 & 200K -- 300K   & Neutral + Aggressive \\
Phase 3a & 300K -- 500K  & + Defensive (staggered start) \\
Phase 3b & 500K -- 2M    & + Conservative (final addition) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Phase 3a (+Defensive):} Defensive commands are added at
        300k steps to introduce moderate speed and tight lane adherence.
    \item \textbf{Phase 3b (+Conservative):} Conservative commands are
        delayed until 500k steps to prevent early convergence to
        degenerate low-speed strategies.
\end{itemize}
